...
export class DayColumn {
    ...
    createWeatherParticles() {
        ...
        this.particleSystem = new MiniParticleSystem(condition, this.mesh, this.options.radius);
    }
    ...
    createThermalAura() {
        ...
        const auraGeo = new THREE.CylinderGeometry(radius * 1.25, radius * 1.4, height * 1.05, 24, 1, true);
    ...
    update(delta) {
        ...
        if (this.windMesh && this.lodLevel !== 'low') {
            ...
            this.windMesh.material.opacity = (0.35 + strength * 0.4) * (0.85 + Math.sin(this.time * 3) * 0.15);
        }
    }
